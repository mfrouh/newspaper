    ...
    t.breakingNews = function(e, i) {
        ...
        r.children(".bn-label"))
          ...
          , k = function() {
            ...
            t <= -l.find("li:first-child").outerWidth() && (l.find("li:first-child").insertAfter(l.find("li:last-child")),
            l.css({
                marginLeft: 0
            })),
        ...
        n.init = function() {
            ...
            "fixed-top" === n.settings.position ? r.addClass("bn-fixed-top").css({
            ...
            "object" == typeof n.settings.source)
                ...
                case "rss":
                    "rss2json" === n.settings.source.usingApi ? ((d = new XMLHttpRequest).onreadystatechange = function() {
                        if (4 == d.readyState && 200 == d.status) {
                            ...
                            for (var r = 0; r < t.items.length; r++)
                                n.settings.source.linkEnabled ? e += '<li><a target="' + n.settings.source.target + '" href="' + t.items[r].link + '">' + s + t.items[r][i] + "</a></li>" : e += "<li><a>" + s + t.items[r][i] + "</a></li>";
                            l.empty().append(e),
                            c = l.children("li"),
                            m = l.children("li").length,
                            w(),
                    ...
                    d.send()) : ((e = new XMLHttpRequest).open("GET", "https://query.yahooapis.com/v1/public/yql?q=" + encodeURIComponent('select * from rss where url="' + n.settings.source.url + '" limit ' + n.settings.source.limit) + "&format=json", !0),
                        ...
                        if (4 == e.readyState)
                            if (200 == e.status) {
                                ...
                                for (var o = 0; o < t.query.results.item.length; o++)
                                    n.settings.source.linkEnabled ? i += '<li><a target="' + n.settings.source.target + '" href="' + t.query.results.item[o].link + '">' + r + t.query.results.item[o][s] + "</a></li>" : i += "<li><a>" + r + t.query.results.item[o][s] + "</a></li>";
                                l.empty().append(i),
                                c = l.children("li"),
                                m = l.children("li").length,
                                w(),
                                ...
                                l.empty().append('<li><span class="bn-loader-text">' + n.settings.source.errorMsg + "</span></li>")
                    }
                    ,
                    e.send(null));
                    break;
                ...
                "html" === n.settings.source ? ("scroll" != n.settings.effect && q(),
                x()) : console.log('Please check your "source" parameter. Incorrect Value');
            var e, d;
        ...
        n.prev = function() {
            !function() {
                ...
                case "scroll":
                    ...
                    l.find("li:last-child").insertBefore(l.find("li:first-child"))),
                    l.stop().animate({
                        marginRight: 0
                    }, 300, function() {
                        p = !0
